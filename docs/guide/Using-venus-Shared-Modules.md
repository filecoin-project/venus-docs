...
1. Deploy minimum hardware and gain access to a publicly hosted Venus chain service.<!--(Checkout venus incubation center page to learn more on how you can get an account setup!)--> (The rest of this tutorial will walk you through this way of deploying a Venus mining operation)
2. Deploy a Venus chain service by yourself. (See [this](How-To-Deploy-MingPool.md) tutorial to learn more)

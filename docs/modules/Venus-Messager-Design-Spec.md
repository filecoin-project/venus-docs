# venus-messager design spec

venus-messager is a module/component for managing local messages, storage of messages for different addresses, keeping track of message status, and controling how often messages gets pushed.

* multi miner support: provides comprehensive APIs for miners to push their messages
* persistent storage: supports MySQL and SQLlite
* nonce management: auto nonce assignment to reduce conflicts
* dynamic configurations of message pushing frequency and volume
* Integration of authentications, tracing and request rate limit
* Extensive CLI commands at your disposal 
...
Authentication includes two parts, one is to verify whether the token used to access the venus-messager is valid, and the other is to verify whether you have the permission to access the API. The following figure is the authentication flow chart.
